...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
    <div class="p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="#">Software</a></div>
        </div>

        <div class="ml-12">
            <div class="mt-2 text-sm text-gray-500">
                Información sobre el Software que Ofrece SQ System C.A y una descripción.
            </div>
<!--
...
-->            
    ...
    <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="#">Contacta con Nosotros </a></div>
        </div>

        <div class="ml-12">
            <div class="mt-2 text-sm text-gray-500">
                Sección en la que podemos colocar correo numero de teléfono y redes sociales.
            </div>
<!--

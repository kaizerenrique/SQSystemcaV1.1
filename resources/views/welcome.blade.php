...
<html lang="es">
  <head>
    ...
    <meta name="author" content="kaizerenrique" />
    <link rel="stylesheet" href="https://unpkg.com/tailwindcss@2.2.19/dist/tailwind.min.css"/>
    <!--Replace with your tailwind.css once created-->
    <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:400,700" rel="stylesheet" />
    <!-- Defina su degradado aquí: use las herramientas en línea para encontrar un degradado que coincida con su marca-->
    <style>
      .gradient {
        background: linear-gradient(90deg, #0957e7 0%, #098ce7 100%);
      }
    </style>
  </head>
      ...
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
          ...
          <ul class="list-reset lg:flex justify-end flex-1 items-center">
            ...
            @else
              <li class="mr-3">
                <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="{{ route('consulta') }}">Consultar Resultados</a>
              </li>
              <li class="mr-3">
    ...
    <div class="pt-24">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="w-full md:w-3/5 py-6 text-center">
          <img class="w-full md:w-4/5 z-50" src="/plantilla/hero.png" />
        </div>
      </div>
    </div>
        ...
        <div class="flex flex-wrap">
          <div class="w-5/6 sm:w-1/2 p-6">
            ...
            <p class="text-gray-600 mb-4">
              El sistema de información QSLAB es un software desarrollado por SQ System c.a con la finalidad de proporcionar a los laboratorios clínicos una plataforma de control y gestión. El cual cuenta con las siguientes características:
            </p>
              <p class="text-gray-600 mb-2">Módulo de registro de pacientes</p> 
              <p class="text-gray-600 mb-2">Módulo de registro de clientes</p>
              <p class="text-gray-600 mb-2">Módulo de registro de usuarios</p>
              <p class="text-gray-600 mb-2">Ingreso de órdenes de exámenes</p>
              <p class="text-gray-600 mb-2">Formato de impresión de facturas configurable</p>
              <p class="text-gray-600 mb-2">Formato de impresión de resultados configurable</p>
              <p class="text-gray-600 mb-2">Formato de impresión de resultados con código QR</p>
              <p class="text-gray-600 mb-2">Envío de resultados vía email y WhatsApp</p>
              <p class="text-gray-600 mb-2">Reporte de Libro de ventas</p>
              <p class="text-gray-600 mb-2">Y Muchas mas funciones</p>
          </div>
          ...
          <div class="w-full sm:w-1/2 p-6 mt-6">
            <div class="align-middle">
              ...
              <p class="text-gray-600 mb-8">
                Mediante el uso de tecnología web, los laboratorios podrán integrar sus sistemas a nuestra plataforma web y los clientes podrán descargar la sus resultados desde esta plataforma aumentando asi los medios y capacidades del software QSLAB.                 
              </p>
            </div>
          </div>
        </div>
...
-->    
    ...
    <section class="container mx-auto text-center py-6 mb-12">
      ...
      <h3 class="my-4 text-3xl leading-tight">
        Consulte los resultados de sus Exámenes
      </h3>
      <button class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
        <a href="{{ route('consulta') }}">Consultar</a>        
      </button>
    </section>
    <!--Footer-->
